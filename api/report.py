...
@app.get("/")
def health():
    return {"ok": True, "msg": "Report Bot API (POST JSON to this path)"}

# NOTE: On Vercel this function lives at /api/report,
# so this route "/" will be reachable at https://<your>.vercel.app/api/report
@app.post("/")
